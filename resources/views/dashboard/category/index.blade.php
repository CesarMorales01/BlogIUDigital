...
@section('listadoCategorias')
    <div class="container">
        ...
        <a href="{{ route('categories.create')}}" class="btn btn-success">Crear categoria</a>
        <br><br>
                ...
                @foreach ($categorias as $categoria)
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('categories.edit', $categoria)}}" class="btn btn-primary">Editar</a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <form id="formDelete" method="POST" action="{{ route('categories.destroy', 0) }}" data-action="{{ route('categories.destroy', 0) }}">
                    @method('DELETE')
                    @csrf
